...
class moveBaseAction():
    ...
    def createGoal(self, x, y, theta_degrees):
        theta_radians = math.radians(theta_degrees)
        quat = tf.transformations.quaternion_from_euler(0, 0, theta_radians)
...
def main():
    ...
    while not rospy.is_shutdown():
        mba.moveToPoint(1, 0, 90)
        rospy.sleep(1)
        mba.moveToPoint(1, -1, 0)
        rospy.sleep(1)
        mba.moveToPoint(0, -1, 180)
        rospy.sleep(1)
        mba.moveToPoint(0, -2, 180)
        rospy.sleep(1)
        mba.moveToPoint(1, -2, 0)
        rospy.sleep(1)
        mba.moveToPoint(1, -3, 270)
        rospy.sleep(1)
        mba.moveToPoint(0, -3, 180)
        rospy.sleep(1)
