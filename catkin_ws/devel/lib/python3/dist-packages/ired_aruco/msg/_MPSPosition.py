...
"""autogenerated by genpy from ired_aruco/MPSPosition.msg. Do not edit."""
import codecs
import sys
...
class MPSPosition(genpy.Message):
  _md5sum = "769b8cad66706e9d423d19e4152250be"
  _type = "ired_aruco/MPSPosition"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """int16 number_found
string[] id
float64[] x
float64[] y
float64[] theta"""
  __slots__ = ['number_found','id','x','y','theta']
  _slot_types = ['int16','string[]','float64[]','float64[]','float64[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MPSPosition, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.number_found is None:
        self.number_found = 0
      if self.id is None:
        self.id = []
      if self.x is None:
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.number_found,) = _get_struct_h().unpack(str[start:end])
      start = end
      end += 4
